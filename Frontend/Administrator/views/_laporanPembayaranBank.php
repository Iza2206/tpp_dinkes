                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="btn-group float-right">
                            ...
                            <a href="../Administrator/dashboard_blank.php?page=Print_Bank" target="_blank" class="btn btn-success btn-md" style="margin-left: 10px;">Export PDF</a>
                        </div>
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th scope="col"style="text-align: center;">No. Rekening</th> 
                                    <th scope="col"style="text-align: center;">Jumlah Bersih</th> 
                                    <th scope="col"style="text-align: center;">Jumlah Yang Dikreditkan Oleh Bank</th>  
                                </tr>
                                <!-- Rencana Bayar 2 Bulan -->
                                <!-- <tr>
                                    <th scope="col" rowspan="2" style="text-align: center;">No</th> 
                                    <th scope="col" rowspan="2" style="text-align: center;">Nama</th> 
                                    <th scope="col" rowspan="2" style="text-align: center;">No. Rekening</th> 
                                    <th scope="col" colspan="3" style="text-align: center;">Jumlah Bersih</th> 
                                    <th scope="col" rowspan="2" style="text-align: center;">Jumlah Yang Dikreditkan Oleh Bank</th>  
                                </tr>
                                <tr>
