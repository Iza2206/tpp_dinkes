...
try {
    if(isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
        ...
        $insData = $mysqli->prepare("INSERT INTO dt_pegawai (inp_nip_pegawai, inp_nm_lengkap, inp_tgl_lahir, inp_alamat, inp_jabatan, inp_npwp, inp_nm_unit, id_unit,
        ...
        $insData->bind_param("ssssssssssssssss", $inp_nip_pegawai, $inp_nm_lengkap, $inp_tgl_lahir, $inp_alamat, $inp_jabatan, $inp_npwp, $inp_nm_unit, $id_unit,
                $inp_golongan, $inp_besaran_tpp, $inp_no_rekening, $inp_status_peg, $inp_umur_pensiun, $inp_saskerja, $inp_bpjs_gaji, $inp_kls_jabatan);
