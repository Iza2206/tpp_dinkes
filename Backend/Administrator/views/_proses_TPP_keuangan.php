        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="controllers/_save_proses_tpp" method="POST">
                    ...
                    <table class="table datatable">
                        ...
                        <?php
                        $no = 1;
                        $cekUnit = $mysqli->query("SELECT * FROM dt_proses_tpp");
                        while($LoadQryProses= $cekUnit->fetch_array()) {
                        ?>
                        <tr>
                        ...
                        <td class="text-center"><?=$LoadQryProses['inp_rencana_bayar'];?></td>
                        <td class="text-center"><?=$LoadQryProses['inp_status'];?></td>
                        <td>
                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#persetujuan<?=$LoadQryProses['id_unit'];?>">
                                Persetujuan
                            </button>
                        </td>
                            </tr>
                            <div class="modal fade" id="persetujuan<?=$LoadQryProses['id_unit'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form action="controllers/_save_update_prosesTPP" method="POST">
                                            <div class="modal-body">
                                                <!-- hanya menampilkan data -->
                                                <div class="row mb-3">
                                                    <label for="inputText" class="col-sm-3 col-form-label">Bulan</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="inp_bulan" value="<?=$LoadQryProses['inp_bulan'];?>" disabled>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="inp_bulan" value="<?=$LoadQryProses['inp_bulan'];?>" />
                                                <input type="hidden" name="id_unit" value="<?=$LoadQryProses['id_unit'];?>" />
                                                <div class="row mb-3">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Tahun</label>
                                                    <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="inp_tahun" value="<?=$LoadQryProses['inp_tahun'];?>" disabled>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="inp_tahun" value="<?=$LoadQryProses['inp_tahun'];?>" />
                                                <div class="row mb-3">
                                                    <label for="inputPassword" class="col-sm-3 col-form-label">Unit Kerja</label>
                                                    <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="inp_nm_unit" value="<?=$LoadQryProses['inp_nm_unit'];?>" disabled>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="inp_nm_unit" value="<?=$LoadQryProses['inp_nm_unit'];?>" />
                                                <div class="row mb-3">
                                                    <label for="inputuraian" class="col-sm-3 col-form-label">Uraian</label>
                                                    <div class="col-sm-9">
                                                    <textarea class="form-control" name="inp_uraian" disabled><?=$LoadQryProses['inp_uraian'];?></textarea>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="inp_uraian" value="<?=$LoadQryProses['inp_uraian'];?>" />
                                                <hr>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" name="inp_rencana_bayar">
                                                    </div>
                                                </div>
...
$(document).ready(function(){
    ...
    $('select[name="inp_nm_unit"]').change(function(){
        ...
        $.ajax({
            url: 'controllers/_get_prosesTPP', // Ganti dengan path menuju file PHP yang menangani permintaan data
            method: 'POST',
